...
tfr.trajectories.plot(tfr_world_pred, country = "FIN", nr.traj = 10, half.child.variant = FALSE,
                      uncertainty = TRUE)
...
for (loc in c("Central Ostrobothnia", "Kymenlaakso")){
  tfr.trajectories.plot(tfr_pred_reg, loc, half.child = FALSE, nr.traj = 10, pi = 95, ylim = c(0.5,2.5))
